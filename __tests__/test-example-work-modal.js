...
describe("ExampleWorkModal component", () => {
     ...
     let component = shallow(<ExampleWorkModal  example={myWork[0]} open={false} />);
     let openComponent = shallow(<ExampleWorkModal  example={myWork[0]} open={true} closeModal={mockCloseFn} />);
